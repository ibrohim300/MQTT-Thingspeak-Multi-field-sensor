...
char pass[] = "makerindo2019";
// Ensure that the credentials here allow you to publish and subscribe to the ThingSpeak channel.
#define channelID 1371926
const char mqttUserName[] = "ED0CBxIADD0uLy09NBUcDSw"; 
const char clientID[] = "ED0CBxIADD0uLy09NBUcDSw";
const char mqttPass[] = "f85BtoWsaII+n1DSoZgyDBEy";
...
void loop() {
  ...
  if ( millis() - lastPublishMillis > updateInterval*2000) {
